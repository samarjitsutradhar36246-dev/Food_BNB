...
const FraudReportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-orange-50 font-sans">
      {/* Top Nav Bar */}
      <div className="bg-white border-b border-gray-100 px-8 py-6 flex justify-center items-center gap-2 ">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex gap-8 items-start">
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <label
                    ...
                    onDrop={handleDrop}
                    className={`flex flex-col items-center justify-center gap-2 w-full py-8 border-2 border-dashed rounded-xl cursor-pointer transition-all ${dragOver ? "border-orange-400 bg-orange-50" : "border-gray-200 bg-gray-50 hover:border-orange-300 hover:bg-orange-50"}`}>
                    <Upload
                      className={`w-8 h-8 ${dragOver ? "text-orange-500" : "text-gray-400"}`}
                    />
                ...
                <div className="flex items-start gap-3 mb-8">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-0.5 w-4 h-4 rounded border-gray-300 text-orange-500 accent-orange-500 cursor-pointer"
                  />
                  <label
                    htmlFor="certify"
          ...
          <div className="w-80 flex-shrink-0 space-y-4">
            ...
            {/* Secure Reporting */}
            <div className="bg-orange-50 rounded-2xl border border-orange-100 p-5 flex items-start gap-3">
      ...
      {/* Auto-save Toast */}
      {showAutoSave && (
        <div className="fixed bottom-6 right-6 bg-gray-900 text-white px-4 py-2.5 rounded-xl shadow-xl flex items-center gap-2 z-50 animate-bounce">
