        ...
        <section className="bg-white px-10 py-16 flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-8">
              Behind every algorithm is a dedicated team of food lovers and
              safety experts. We manually review complaints, conduct spot
              checks, and support our community around the clock.
            </p>
