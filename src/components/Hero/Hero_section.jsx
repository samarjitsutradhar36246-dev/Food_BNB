                  ...
                  <div
                    ...
                    <div
                      ...
                      <img
                        src={item.src}
                        alt={item.name}
                        className="w-full h-full object-contain contrast-120"
                      />
                    </div>
                  </div>
                </div>
