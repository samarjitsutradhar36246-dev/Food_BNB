...
const MomsKitchenInfo = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Header Section */}
      <header className="bg-orange-600 text-white py-20 px-4">
      ...
      <main className="max-w-5xl mx-auto px-4 py-16">
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              <Heart className="w-10 h-10 text-red-500" fill="#dc2626" />
        ...
        <section className="mb-20 bg-orange-600 rounded-2xl p-8 md:p-12 text-white">
        ...
        <section className="mb-16">
          <div className="bg-red-50 border-l-4 border-orange-600 rounded-l-2xl p-8">
        ...
        <div className="text-center">
          <Link
            to="/"
            className="inline-flex items-center gap-2 bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-red-500 transition-colors">
